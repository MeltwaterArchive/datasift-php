<?php
	/**
	 * This simple script wraps up calling the Historics examples.
	 *
	 * Usage: historics.php <username> <api_key> <command> <arg1> <arg2> ... <argn>
	 *
	...
	$____command_filename = dirname(__FILE__).'/historics/'.$____command.'.php';
