<?php
	...
	/**
	 * This class is used by the push examples to remove the noise of dealing with command line arguments.
	 */
	class Env {
		public $user = null;
		public $args = array();
		...
		public function displaySubscriptionDetails($sub)
		{
		    ...
		    echo 'Created at:    '.date('r', $sub->getCreatedAt()).PHP_EOL;
		    echo 'Last request:  '.date('r', $sub->getLastRequest()).PHP_EOL;
		    echo 'Last success:  '.date('r', $sub->getLastSuccess()).PHP_EOL;
